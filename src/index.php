    ...
    <div class="section">
        ...
        <div class="technician-features">
            <div class="technician-feature">
                ...
                <p style="color: white; opacity: 40%">Créez des machines dans l'inventaire via un simple formulaire <br>ou modifiez des informations relatives à elles.</p>
            </div>
            <div class="technician-feature">
                ...
                <p style="color: white; opacity: 40%">Automatisez la création de machines via l'importation de machines depuis un fichier csv, ou bien la récupération via l'exportation. </p>
            </div>
            <div class="technician-feature">
                <img src="images/icones/search.svg" alt="search icon" width="50" height="50">
                <h3>Recherche de machines</h3>
                <p style="color: white; opacity: 40%">Retrouvez facilement des machines en naviguant entre les catégories<br> "moniteurs" et "unité centrales", ainsi que dans le rébut.</p>
            </div>
            <div class="technician-feature">
                <img src="images/icones/trash.svg" alt="trash icon" width="50" height="50">
                <h3>Suppression de machines dans l'inventaire</h3>
                <p style="color: white; opacity: 40%">Supprimez des machines de l'inventaire<br> et retrouvez les dans le rébut.</p>
            </div>
        </div>
    </div>
